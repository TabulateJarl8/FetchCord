...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(30, 20, 211, 331))
        ...
        self.terminalName = QtWidgets.QComboBox(self.verticalLayoutWidget)
        self.terminalName.setInsertPolicy(QtWidgets.QComboBox.InsertAtBottom)
        self.terminalName.setPlaceholderText("")
        self.terminalName.setObjectName("terminalName")
        self.terminalName.addItem("")
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(250, 200, 412, 190))
